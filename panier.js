...
//**************************formulaire et envoi au serveur *******************/
...
function send(e){    
  ...
  // creation du constructeur Client
class Client {
...
// récuperation des valeurs du formulaire et du montant TTC
let resultat = {
             contact : {
 ...
 // Envoie des informations sur le serveur  
